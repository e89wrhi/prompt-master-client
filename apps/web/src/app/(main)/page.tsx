      ...
      <DetailWidthWrapper className="relative z-10 !bg-transparent pt-20 pb-32 shadow-none">
        <header className="mb-24 flex flex-col items-center text-center">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-neutral-600 dark:text-neutral-400 sm:text-xl">
            Stop guessing what works. Discover the definitive library of
            production-ready AI templates, expertly crafted and tested for peak
            performance.
          </p>
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              href="#library"
              className="group inline-flex h-12 items-center justify-center rounded-full bg-neutral-900 px-8 font-medium text-white transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-neutral-900/20 dark:bg-white dark:text-black dark:hover:shadow-white/10"
            >
              Browse Library
            </Link>
            <Link
              href="/custom-prompt"
              className="inline-flex h-12 items-center justify-center rounded-full bg-amber-500 hover:bg-amber-600 px-8 font-medium text-neutral-900 backdrop-blur transition-all dark:text-white"
            >
              Workspace{' '}
              <Pencil className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        </header>
