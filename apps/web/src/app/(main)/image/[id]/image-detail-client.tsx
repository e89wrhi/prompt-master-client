...
export function ImageDetailClient({ prompt, allPrompts }: ImageDetailClientProps) {
  return (
    <div className="flex w-full max-w-[1400px] mx-auto py-8 px-4 sm:px-6 gap-10">
      ...
      <div className="w-72 hidden lg:flex flex-col gap-6 border-r pr-6 border-neutral-200 dark:border-neutral-800">
        <h2 className="font-extrabold text-2xl sticky top-0 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md py-4 z-10 text-neutral-900 dark:text-white border-b border-transparent">
          Gallery
        </h2>
              ...
              return (
                ...
                >
                  <div className="relative aspect-[4/3] w-full bg-neutral-100 dark:bg-neutral-800">
                    ...
                    />
                    <div className={`absolute inset-0 transition-opacity duration-300 flex flex-col justify-end p-3 
                      ...
                      <p className="text-sm text-white font-bold line-clamp-2">{p.title}</p>
                    </div>
                  </div>
                </Link>
              );
